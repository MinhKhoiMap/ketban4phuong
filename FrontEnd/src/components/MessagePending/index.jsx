...
const MessagePending = () => {
  return (
    <div className="message-pending__wrapper">
      <div className="message-pending__img">
        <svg className="message-big" width="157" height="146">
          <path
      ...
      <div className="message-pending__label">Say Hello</div>
      <div className="message-pending__note">
